                            ...
                            {documents.map((document, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span title={created_at.toLocaleString()}>
                                            {Boolean(document.created_at) && created_at.toLocaleDateString()}
                                        </span>
                                        <span title={modified_at.toLocaleString()}>
                                            {Boolean(document.modified_at) && modified_at.toLocaleDateString()}
                                        </span>
                                        <span title={document.modified_by}>
                                            {document.modified_by && document.modified_by.split('@').shift()}
                                        </span>
                                    </div>
                                )
                            })}
